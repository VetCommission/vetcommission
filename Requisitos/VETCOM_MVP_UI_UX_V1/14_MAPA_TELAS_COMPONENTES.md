...
| Admin | Profissional | Formulário | Salvar |
| Admin | Procedimentos | Filtros, tabela | Novo procedimento |
| Admin | Procedimento | Formulário | Salvar |
| Admin | Regras | Filtros, tabela | Nova regra |
| Admin | Regra | Etapas do formulário, prévia | Salvar regra |
| Admin | Nova produção | Formulário, prévia cálculo | Registrar produção |
| Admin | Produções | Filtros, tabela | Consultar/detalhar |
...
| Profissional | Procedimento detalhe | Dados, cálculo, status | Contestar |
| Profissional | Minhas comissões | Total, composição | Ver extrato |
